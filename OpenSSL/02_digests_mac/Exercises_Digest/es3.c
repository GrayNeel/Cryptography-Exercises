 ...
 * 
 * 
 * 3. Writes a program in C that, using the OpenSSL library, computes the hash of the content 
 * of a file, passed as first parameter from the command line, using the algorithm passed as second parameter.
 */
#include <stdio.h>
